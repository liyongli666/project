		...
		data() {
			return {
				...
				orderTypeLise:[
					...
					{name:'我的卡卷',icon:'l1.png',badge:0},
					{name:'我的订单',icon:'l2.png',badge:0},
					{name:'我的亲友',icon:'l3.png',badge:0}
				],
				severList:[
					[
						{name:'导入包裹',icon:'w1.png'},
						{name:'包裹星球',icon:'w2.png'}
					],
					[
						{name:'我的地址薄',icon:'w3.png'},
						{name:'我的证件',icon:'w4.png'},
						{name:'实人通行证',icon:'w5.png'},
						{name:'服务中心',icon:'w6.png'},
						{name:'我要反馈',icon:'w7.png'},
						{name:'3小时公益',icon:'w8.png'}
					]
				],
			};
		},
